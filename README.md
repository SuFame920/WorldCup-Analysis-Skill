...
<img src="assets/hitrate.svg" alt="近 7 日分项命中率趋势 · 6条曲线" width="100%">

> **分项命中率** = 每个玩法命中一档即算中(分母=5玩法×N场=5N)。**命中的预测档加粗**,未加粗即未中。胜平负 / 半全场均以"vs 左侧球队"为视角(胜=左队胜);让球列 `±N` + 赛果 = 左队让(−)/ 受让(+)N 球后的左队赛果,净胜恰为 N 即"平"(走盘)。**累计分项命中率 111/150 ≈ 74% (30 场已结算)**。SVG 含 6 条曲线:整体分项 + 胜平负 · 让球 · 比分 · 大小球 · 半全场各自的分项命中率。
...
**v1.6 分项 23/30 = 77%** · 1X2 6/6 · 让球 6/6 · 比分 2/6 · 大小球 3/6 · 半全场 6/6
...
**v1.3 分项 16/30 = 53%** · 1X2 5/6 · 让球 6/6 · 比分 3/6 · 大小球 2/6 · 半全场 2/6
