...
> **分项** = 每个玩法命中一档即算中(分母=分项数)　**逐档** = 每个预测档单独算(分母=所有预测档数)。**命中的预测档加粗**,未加粗即未中。胜平负 / 半全场均以"vs 左侧球队"为视角(胜=左队胜);让球列 `±N` + 赛果 = 左队让(−)/ 受让(+)N 球后的左队赛果,净胜恰为 N 即"平"(走盘)。**累计命中率｜分项 111/150 ≈ 74%　·　逐档 111/281 ≈ 40%　(30 场已结算)**
...
**命中率｜v1.6 分项 23/30 = 77%　·　逐档 24/61 ≈ 39%**　·　🌟 1X2 **6/6 方向全对**(83%跨批) · ⭐ 佛得角 0-0 绞杀死锁满分/埃及 1-1 满分(5/5双卡) · ⭐ 让球 6/6 方向全对(铁律连续) · ⚠️ 挪威轮换10人信息缺失→比分/大小球双双错 · ⚠️ 塞内加尔13'红牌颠覆totals · 🆕 新增校准#11(MD3首发F渠道最高优先)/#12(早红牌极端化)/#13(哑火跨对手禁止)
