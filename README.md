...
> **分项** = 每个玩法命中一档即算中(分母=分项数)　**逐档** = 每个预测档单独算(分母=所有预测档数)。**命中的预测档加粗**,未加粗即未中。胜平负 / 半全场均以"vs 左侧球队"为视角(胜=左队胜);让球列 `±N+赛果` = 左队让(−)/ 受让(+)N 球后的左队赛果,净胜恰为 N 即"平"(走盘退款)。**累计命中率｜分项 86/150 = 57%　·　逐档 86/281 ≈ 31%　(24 场已结算)**
...
**命中率｜分项 18/30 = 60%　·　逐档 18/57 ≈ 32%**　·　🌟 让球 **6/6 全中**(含4走盘!) — 铁律级增量 · ⭐ 日-瑞全次选对冲命中(4/5,校准#9黄金验证) · ⭐ 库拉索 0-2 科特迪瓦(4/5,比分精确命中!) · ⭐ 突尼斯 1-3 荷兰(4/5) · 厄瓜多尔 2-1 德国(1/5,本批最差,"必须赢vs已出线"反转) · 三种MD3亚型被识别:解放效应/无利害表演赛/绞杀死锁
